...
const Checkout = (props) => {
  const [formInputsValidaty, setFormInputsValidity] = useState({
    name: true,
    street: true,
    city: true,
    postalCode: true,
  ...
  return (
    <form className={classes.form} onSubmit={confirmHandler}>
      <div className={nameControlClasses}>
        ...
        {!formInputsValidaty.name && <p>Please entere a valid name!</p>}
      </div>
      <div className={streetControlClasses}>
        <label htmlFor="street">Street</label>
        <input type="text" id="street" ref={streetInputRef} />
        {!formInputsValidaty.street && <p>Please entere a valid street!</p>}
      </div>
      ...
      <div className={cityControlClasses}>
        ...
        {!formInputsValidaty.city && <p>Please entere a valid city!</p>}
      </div>
